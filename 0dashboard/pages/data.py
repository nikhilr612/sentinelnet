...
def create_control_panel() -> dbc.Container:
    return dbc.Container(
        ...
        children=[
            ...
            dcc.Dropdown(id="data-select-device", options=[], style={"width": "100%"}, className='dbc'),
            html.Br(),
            dbc.Button("Refresh Device List", id="data-refresh-devices", n_clicks=0),
            html.P("Select Data File"),
            dcc.Dropdown(id="data-select-file", options=[], style={"width": "100%"}),
            html.Br(),
