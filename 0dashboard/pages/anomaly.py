...
from pages.utils import create_modal, create_param_table, create_metric_table, create_empty_figure
...
def create_control_panel() -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            dcc.Dropdown(id="anomaly-select-device", options=[], style={"width": "100%"}),
            html.Br(),
            html.Button("Refresh Device List", id="anomaly-refresh-devices", n_clicks=0),
