...
################################################################################
## Form generated from reading UI file 'mainwindowcsOFDS.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionList_Nodes.setIcon(icon)
        ...
        self.next_graph = QPushButton(self.centralwidget)
        self.next_graph.setObjectName(u"next_graph")
        self.next_graph.setMaximumSize(QSize(120, 16777215))

        self.verticalLayout.addWidget(self.next_graph)

        MainWindow.setCentralWidget(self.centralwidget)
        self.label1.raise_()
        self.next_graph.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.next_graph.setText(QCoreApplication.translate("MainWindow", u"Next Graph", None))
